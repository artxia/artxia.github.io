...
1. Reference the [suggested format](/handbook/leadership/1-1/suggested-agenda-format) as necessary.
...
1. If you have few items on the agenda from the report try the following questions:
  ...
  - Have you identified any career development opportunities that I can help you with?
    - For example: [Interning for Learning](/handbook/people-group/promotions-transfers/#sts=Interning for Learning)
...
When taking over management of existing team members consider the following guidelines for ensuring a smooth transition:
1. New Manager: Create a new 1-1 invite with the team member and add the former manager
1. New Manager: Start a fresh 1-1 Google Doc for the new 1-1 and share with the team member and former manager.
1. Existing Team Member: Transfer any relevant content to the new 1-1 Google Doc
1. Group: Continue with 1-2s for one month with the new manager taking on an as-needed basis
1. New Manager: After one month, remove the former manager from the 1-1 invite and the 1-1 Google Doc
