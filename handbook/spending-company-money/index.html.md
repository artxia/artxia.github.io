...
1. It is uncommon for you to need all of the items listed below. Read [GitLab's guide to a productive home office or remote workspace](/company/culture/all-remote/workspace/), and use your best judgement and buy them as you need them. If you wonder if something is common, feel free to ask People Ops (and in turn, People Ops should update the list).
...
The below averages are what GitLab will reimburse. If you prefer to spend more on a given item, that's OK. You may attach the receipt during expensing which shows the full purchase price and simply expense the `GitLab Average Price in USD` portion. For example, if you purchase a high-end Steelcase ergonomic chair, you are welcome to expense a portion of it and cover the rest with personal funds. 
...
### Software
1. We have central [license management](/handbook/tools-and-tips/#jetbrains) for you to request licenses for JetBrains' products like RubyMine / GoLand.
1. We do not issue Microsoft Office 365 licenses, as GitLab uses Google's G Suite ([Docs](/handbook/communication/#google-docs), Slides, Sheets, etc.) instead.
1. For security related software, refer to the security page for [laptop and desktop configuration](/handbook/security/#laptop-or-desktop-system-configuration).
...
If working from home is not practical for a day, a month, a year, forever, please feel free to rent out a co-working space at the expense of the company. This can include non-traditional spaces that require a membership as long as you average ~4 working days per month at the space. 
...
GitLab team members are allotted [$500 USD](/handbook/people-group/global-compensation/#exchange-rates) per fiscal year to spend on one or multiple training courses. Reimbursement past the [$500 USD](/handbook/people-group/global-compensation/#exchange-rates) total allotment requires manager approval.
...
1. Work-related conferences, including travel, lodging, and meals. If total costs exceed [$500 USD](/handbook/people-group/global-compensation/#exchange-rates), reimbursement requires prior approval from your manager.
...
GitLab grants [$100 USD](/handbook/people-group/global-compensation/#exchange-rates) per GitLab team member for a holiday in November, December, or January. We encourage GitLab team members to self organize holiday parties with those close by, but meeting up with GitLab team members is not a requirement as it is understood that timing and location of holiday parties will play a factor in ability to attend. 

For those who do not meet up with GitLab team members, you may expense up to $100 USD during November, December, or January for a holiday celebration of your choosing. 

This is in addition to the [IACV Target Dinner Evangelism Reimbursement](/handbook/incentives/#iacv-target-dinner-evangelism-reimbursement), should GitLab reach its targets during those months.

If a group of team members, Department or Division so choose, they are welcome to donate a portion of their per person Holiday budget to Charity. Also, they are welcome to spend a portion of their $100USD Holiday per person budget on self-ordered, team-specific swag. Follow the instructions in the [Internal GitLab Swag Ordering](https://about.gitlab.com/handbook/marketing/corporate-marketing/#internal-gitlab-swag-ordering) section of the Corporate Marketing page. Be sure to create an issue in the Corporate Marketing project to ask for design support and contact `swag@gitlab.com` to determine final pricing costs, including shipping.
...
1. For flights longer than 8 hours, you can expense:
   * Up to the first [$300 USD](/handbook/people-group/global-compensation/#exchange-rates) for an upgrade to Business Class on flights longer than 8 hours if you are taller than 1.95m or 6'5".
    * Up to the first [$100 USD](/handbook/people-group/global-compensation/#exchange-rates) for an upgrade to Economy Plus (no height restriction) on flights longer than 8 hours.
...
1. If you are a team member and incurred an expense charged in a currency different from the one you use to submit your invoices, use the conversion rates specified in the [global compensation section of the handbook](/handbook/people-group/global-compensation/#exchange-rates). If the expense currency doesn’t exist in that list, refer to the conversion rates in [oanda](https://www.oanda.com/currency/converter/). Make sure to set the expense date in the currency converter form.
...
1. Max Expense Amount - [$5,000 USD](/handbook/people-group/global-compensation/#exchange-rates) - NOTE - If you are a corpoate credit card holder, please refer to the [corporate credit card policy section](https://about.gitlab.com/handbook/finance/accounting/#credit-card-use-policy) for those specific instructions and thresholds. 
1. Receipt Required Amount - [$25 USD](/handbook/people-group/global-compensation/#exchange-rates)
