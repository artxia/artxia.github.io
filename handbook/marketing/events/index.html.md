...
* [Field Marketing](https://gitlab.com/gitlab-com/marketing/field-marketing/issues/new?issuable_template=Event_Field_Marketing)
  ...
  *  For EMEA Field Marketing event requests, please select and utilize the [`EMEA_Event_Request_Template`](https://gitlab.com/gitlab-com/marketing/field-marketing/issues/new?issuable_template=EMEA_Event_Request_Template)
  *  For APAC Field Marketing event requests, please select and utilize the [`APAC_Event_Request_Template`](https://gitlab.com/gitlab-com/marketing/field-marketing/issues/new?issuable_template=APAC_Event_Request_Template)
...
`For Corporate Event DRIs:` If you are the DRI for the event and want to get started on planning for a specific event please use the [Corporate Event Template](https://gitlab.com/gitlab-com/marketing/corporate-marketing/issues/new?issuable_template=Corporate-Event-Request) and follow guide in template to get started on planning, budget request, and contracting. This needs to be completed before moving into contracting. See below for "event execution" for next steps once you have opened and completed issue template.
...
{:.no_toc}
  * Audience minimum requirement of 5000+ attendees NA, 3000+ other territories and...
...
1. **Event Owner** creates issue using the appropriate regional template with auto-applied `status::plan` label
     ...
     - [Corporate Event](https://gitlab.com/gitlab-com/marketing/corporate-marketing/issues/new?issuable_template=corporate-event-request#)
...
1. **Event Owner** creates issue using the appropriate regional template with auto-applied `status::plan` label
     ...
     - [EMEA_Event_Field_Marketing](https://gitlab.com/gitlab-com/marketing/field-marketing/issues/new?issuable_template=EMEA_Event_Field_Marketing)
     - [Corporate Event](https://gitlab.com/gitlab-com/marketing/corporate-marketing/issues/new?issuable_template=corporate-event-request#)
1. **Event Owner** creates finance issue following the [Procure to Pay Process](/handbook/finance/procure-to-pay/#procure-to-pay-process) and includes the `campaign tag` from the budget document. 
...
### Step 3
1. If the event is approved to move forward to contracting and is on the budget sheet, the DRI will start finance issue for contract review and signature following the [Procure to Pay Process](/handbook/finance/procure-to-pay/#procure-to-pay-process). The finance issue will include:
     - ROI calculation for event in the final cost section.
...
1. For **Corporate events**, the DRI must track the event budget. The expectation is budget will be updated weekly/ accurate for your 1:1 with your manager.
...
* If the campaign tag has been created in Netsuite through a finance issue, they must also ping Kim Stithem and Cristal McClure with the original campaign tag and the updated campaign tag.
...
**Nadel Address for Returns for Field Marketing:**      
Towne Receiving Dept - #GIT476 (FM)    
Towne AllPoints    
