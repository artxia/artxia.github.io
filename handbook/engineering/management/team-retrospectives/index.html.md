...
### How to run the meeting(s)

* Attendees will be encouraged to read the content of the document before the meeting.  
* A volunteer from each section will read a subset of the items most important to them. (We will not read the entire document during the session). Doing so leaves more time for discussion.
