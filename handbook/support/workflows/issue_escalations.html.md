...
title: Creating and Escalating Issues
...
- customer size/type/etc. if relevant
- What parts of the issue are important to the customer and why?
- Has the customer tried any workarounds?
- What is the priority of the issue to the customer?
...
As per our [Statement of Support](/support/#issue-creation), the Support Team will generally ask the customer to create feature requests. Customers can send the link (back) to us to ensure that appropriate labels are added. Team members should also add any additional relevant information as a comment.

If you create a feature proposal, please follow the same process as [Creating Issues](#creating-issues) by using the `Feature Proposal` template.
