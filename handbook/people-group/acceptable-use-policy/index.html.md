...
As per the [onboarding issue procedures](https://gitlab.com/gitlab-com/people-group/employment/blob/master/.gitlab/issue_templates/onboarding.md) outlined in our handbook, evidence of device encryption and device serial number must be provided to IT Ops prior to the completion of onboarding period.
...
All GitLab-owned computing resources must be [returned](/handbook/offboarding/#returning-property) upon separation from the company.
...
- [Asset return procedure](/handbook/offboarding/#returning-property)
