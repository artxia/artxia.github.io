...
in what plan based on [the paid tiers](/handbook/product/#paid-tiers).
...
1. Raising prices on our lower tiers might cause more revenue in the short term, both directly and by compelling most organizations to move to higher tiers. But the minority of organizations that switch to a competition will cause them to be much harder for us to reach in the future and will allow competitors a [flywheel effect](https://about.gitlab.com/company/strategy/#dual-flywheels) of their own. This tradeoff has to be calculated explicitly when raising prices.
...
1. While the absolute value of higher tiers is better and that seems the most rational measure people also do look at relative value and we should make sure that the price to go to a higher tiers is percieved well.
...
1. Lots of companies don't want to forgo support, espacially in their first year, and there is little price elasticity there.
...
Companies like Microsoft use successfully to get people to use more of their ecosystem.
...
1. Better customer experience due to ongoing product availability and less frequent administration and and billing contact.
...
When moving features to lower priced plans, it is important that we take an overall view.
...
To propose bringing a feature that exists in Premium to Core, for example, follow the process outlined in the [Move a Feature Down issue template](https://gitlab.com/gitlab-com/Product/issues/new?issuable_template=Move-A-Feature-Down). 
