...
| [@gitlab-com/support/dotcom](https://gitlab.com/gitlab-com/support/dotcom)            | All GitLab.com Support members |
...
| Channel                                                                | Purpose                                                   |
|------------------------------------------------------------------------|-----------------------------------------------------------|
| [#support-team-chat](https://gitlab.slack.com/archives/CCBJYEWAW)      | Support team lounge for banter, chat and status updates   |
...
| [#support-managers](https://gitlab.slack.com/archives/CBVAE1L48)       | Discuss matters which require support managers' attention |
| [#spt-hiring](https://gitlab.slack.com/archives/CE9S6JW4S)             | Discuss support team hiring-related matters               |
...
#### Leadership Meetings
Support leadership (Managers and Director) meet in cross-regional synchronous meetings weekly.
...
The organization of these meetings is covered in the [Leadership Meeting Workflow](workflows/how-to-leadership-sync.html).
...
| UX         | Docs/Tech Writing   | Mike Lewis          | Tom Atkins          | Cynthia Ng & Greg Myers | N/A |
...
- either specifiy your manager as the person who covers for you, or leave a note to ping `#support-managers` per [our escalation procedure](https://about.gitlab.com/handbook/support/internal-support/#i-want-to-draw-attention-to-an-existing-support-ticket)
...
- [Support Onboarding](/handbook/support/onboarding)
   ...
   - [GitLab.com Support Onboarding Checklist](https://gitlab.com/gitlab-com/support/support-training/blob/master/.gitlab/issue_templates/Onboarding%20-%20GitLab.com%20Support%20Agent.md)
