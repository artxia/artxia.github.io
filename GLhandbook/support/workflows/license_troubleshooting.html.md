...
1. **User wants to know when they will receive the license key.** The license key will be emailed to the email address associated with the purchase once subscription payment is approved internally by the billing team.  If there is an unusually long delay, assign the ticket to the "License, Renewals and Upgrades queue and ping in the #support_fulfillment Slack channel if escalation is necessary.
...
>**EXAMPLE 1**
   ...
   >- At renewal, the license would need to be:
       >1. Users count: 12
       >2. Previous users count: 10
       >3. Trueup count: 5 
...
3. [GitLab.com Subscription Management](/handbook/marketing/product-marketing/enablement/dotcom-subscriptions/) _(internal audience)_
