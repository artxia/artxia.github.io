...
Dev.gitlab.org is a GitLab instance hosted in Azure. It's currently used for building docker images and GitLab packages that are uploaded to AWS S3. It is also used as an OAuth authentication service which allows users to to sign in to other services using their gitlab.dev.org account, such as:
