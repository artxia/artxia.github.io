...
1. Week 1: Intern Fast Boot
    ...
    - By the end of Week 1, we expect an intern will:
        - Have completed key [Day 1-5 onboarding tasks](https://gitlab.com/gitlab-com/people-group/employment/blob/master/.gitlab/issue_templates/engineering-intern-job-specific.md)
